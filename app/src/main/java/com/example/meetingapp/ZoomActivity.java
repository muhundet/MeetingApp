...
public class ZoomActivity extends AppCompatActivity implements AuthConstants {
    ...
    public void initializeSdk(Context context) {
        ...
        int errorCodeDebug, internalErrorCodeDebug;
        ...
        ZoomSDKInitializeListener listener = new ZoomSDKInitializeListener() {
            ...
            @Override
            public void onZoomAuthIdentityExpired() {
                Log.i("TAG", "Zoom Auth Identity Expired");
            }
        };
    ...
    private void initViews() {
        ...
        btnJoin.setOnClickListener(new View.OnClickListener() {@Override
    ...
    public void joinMeeting(Context context, String meetingNumber, String password) {
        ...
        params.displayName = "Display Name"; // TODO: Enter your name
    ...
    private void createJoinMeetingDialog() {
        new AlertDialog.Builder(this).setView(R.layout.dialog_meeting_cred).setPositiveButton("Join", new DialogInterface.OnClickListener() {@Override
